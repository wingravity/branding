...
teal only as an underline or bullet. `primaryDeep` at large sizes only.
...
| [`wordmark-on-light.svg`](logo/wordmark-on-light.svg) | `#18181b` | `#66DBC9` | Light surfaces |
...
- Recolour the teal half. It stays `#66DBC9` on every background, including
  monochrome contexts.
